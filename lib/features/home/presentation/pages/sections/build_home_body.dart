...
import 'package:task_craft/features/home/presentation/widgets/add_task_bottom_sheet.dart';
...
class BuildHomeBody extends StatelessWidget {
  ...
  Widget buildLoadingUI() {
    return SliverToBoxAdapter(child: const StartNewInitiativeCard());
  }
  ...
  Widget buildErrorUI(BuildContext context) {
   ...
   Widget buildProjectsUI(List<ProjectEntity> projects) => ProjectsLoadedUI(projects: projects,);
  void addTask(BuildContext context) {
    return openAdditionSheet(context, builder: (_) =>AddTaskBottomSheet(
