...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _FetchUserProfile value)?  fetchUserProfile,TResult Function( _ProfileSaved value)?  profileSaved,TResult Function( _LogOut value)?  logOut,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FetchUserProfile() when fetchUserProfile != null:
return fetchUserProfile(_that);case _ProfileSaved() when profileSaved != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _FetchUserProfile value)  fetchUserProfile,required TResult Function( _ProfileSaved value)  profileSaved,required TResult Function( _LogOut value)  logOut,}){
final _that = this;
switch (_that) {
case _FetchUserProfile():
return fetchUserProfile(_that);case _ProfileSaved():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _FetchUserProfile value)?  fetchUserProfile,TResult? Function( _ProfileSaved value)?  profileSaved,TResult? Function( _LogOut value)?  logOut,}){
final _that = this;
switch (_that) {
case _FetchUserProfile() when fetchUserProfile != null:
return fetchUserProfile(_that);case _ProfileSaved() when profileSaved != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  fetchUserProfile,TResult Function( UserEntity user)?  profileSaved,TResult Function()?  logOut,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FetchUserProfile() when fetchUserProfile != null:
return fetchUserProfile();case _ProfileSaved() when profileSaved != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  fetchUserProfile,required TResult Function( UserEntity user)  profileSaved,required TResult Function()  logOut,}) {final _that = this;
switch (_that) {
case _FetchUserProfile():
return fetchUserProfile();case _ProfileSaved():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  fetchUserProfile,TResult? Function( UserEntity user)?  profileSaved,TResult? Function()?  logOut,}) {final _that = this;
switch (_that) {
case _FetchUserProfile() when fetchUserProfile != null:
return fetchUserProfile();case _ProfileSaved() when profileSaved != null:
return profileSaved(_that.user);case _LogOut() when logOut != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( UserEntity user)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( UserEntity user)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( UserEntity user)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
