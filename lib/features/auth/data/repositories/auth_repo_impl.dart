...
class AuthRepositoryImpl implements AuthRepository {
  ...
  Future<Either<Failure, UserEntity>> login({
    ...
    try {
      ...
      final errorMessage = DioErrorHandler.handle(
        e,
        customFallback: 'خطأ في تسجيل الدخول. تأكد من البيانات.',
      );
  ...
  Future<Either<Failure, UserEntity>> signUp({
    ...
    try {
      ...
      final errorMessage = DioErrorHandler.handle(
        e,
        customFallback: 'خطأ في التسجيل. البريد الإلكتروني قد يكون مستخدم.',
      );
      return Left(ServerFailure(message: errorMessage));
    }
  }
      ...
      return Left(
        ServerFailure(
          message: DioErrorHandler.handle(
            e,
            customFallback: 'خطأ في تسجيل الخروج.',
          ),
        ),
      );
    }
    ...
    try {
      ...
      return Left(
        ServerFailure(
          message: DioErrorHandler.handle(
            e,
            customFallback: 'خطأ في تحميل الملف الشخصي.',
          ),
        ),
      );
    }
